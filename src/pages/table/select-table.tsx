...
export default function () {
  ...
  useEffect(() => {
    if (tableDom.current) {
      instance.current = new VTable.ListTable(tableDom.current, option)
    }
    instance.current?.selectCells([{ start: { col: 1, row: 2 }, end: { col: 4, row: 2 } }])
    // console.log("🚀 ~ file: select-table.tsx:324 ~ useEffect ~ instance.current:", instance.current)
  }, [])
  return (<div style={{ height: '600px', width: '800px' }} ref={tableDom}>
    球球
  </div>)
}